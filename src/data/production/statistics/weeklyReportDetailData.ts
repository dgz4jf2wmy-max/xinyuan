...
export const mockWeeklyReportBaseInfo = {
  id: 1,
...
// 再造原料生产情况
export const mockWeeklyMaterialDetails: ProductionWeeklyReportMaterialDetail[] = [
  {
    id: 1,
    productType: '再造梗丝',
    brandCode: 'GS60',
...
// 香精香料生产情况
export const mockWeeklyFlavorDetails: ProductionWeeklyReportFlavorDetail[] = [
  // 料液
...
export const mockWeeklyTestDetails: ProductionWeeklyReportTestDetail[] = [
  { id: 1, recipeName: '-', actualProduction: 0, remark: '' },
];

export const mockWeeklyOtherInfo: ProductionWeeklyReportOtherInfo = {
  ...
  otherActivitiesSummary: '再造烟叶补贴标200箱，再造梗丝补贴标5192箱，原料预混打包5.4吨，烟末筛分12吨，翻箱55吨。'
};

export const mockWeeklyWorkSummary: ProductionWeeklyReportWorkSummary = {
