...
export const mockMonthlyProductionPlanDetail: MonthlyProductionPlanBase = {
  ...
  details: [
    // --- 再造原料明细 (合并演示项) ---
    // HBZY-10 合并项 (合计 200)
    { id: 'dr5-1', productType: '再造烟叶（省外）', brandGrade: 'HBZY-10', subBrandGrade: 'HBZY-10-01', productName: '再造烟叶', productCode: 'ZY-HB-10', customerName: '湖北中烟(武汉)', specification: '标准', requirementAmount: 120.0, unit: '吨', unitPriceExclTax: 13000, unitPriceInclTax: 14690, amountExclTax: 1560000, applicantName: '章经理', applicantDepartment: '市场部', productionType: '自产', expectedCompletionDate: '2026-01-15' },
    { id: 'dr5-2', productType: '再造烟叶（省外）', brandGrade: 'HBZY-10', subBrandGrade: 'HBZY-10-02', productName: '再造烟叶', productCode: 'ZY-HB-10', customerName: '河南中烟(许昌)', specification: '标准', requirementAmount: 80.0, unit: '吨', unitPriceExclTax: 13000, unitPriceInclTax: 14690, amountExclTax: 1040000, applicantName: '章经理', applicantDepartment: '市场部', productionType: '自产', expectedCompletionDate: '2026-01-20' },

    // JSN08 合并项 (合计 200)
    { id: 'dr6-1', productType: '再造烟叶（省外）', brandGrade: 'JSN08', subBrandGrade: 'JSN08-01', productName: '再造烟叶', productCode: 'ZY-JS-08', customerName: '广西中烟', specification: '标准', requirementAmount: 150.0, unit: '吨', unitPriceExclTax: 13500, unitPriceInclTax: 15255, amountExclTax: 2025000, applicantName: '孙八', applicantDepartment: '市场部', productionType: '自产', expectedCompletionDate: '2026-01-18' },
    { id: 'dr6-2', productType: '再造烟叶（省外）', brandGrade: 'JSN08', subBrandGrade: 'JSN08-02', productName: '再造烟叶', productCode: 'ZY-JS-08', customerName: '黑龙江烟草', specification: '标准', requirementAmount: 50.0, unit: '吨', unitPriceExclTax: 13500, unitPriceInclTax: 15255, amountExclTax: 675000, applicantName: '孙八', applicantDepartment: '市场部', productionType: '自产', expectedCompletionDate: '2026-01-22' },

    // 其他单项
    { id: 'dr1', productType: '再造梗丝（省内）', brandGrade: 'GS22', subBrandGrade: 'GS22-01', productName: '再造梗丝', productCode: 'GS-SN-22', customerName: '江苏中烟徐州卷烟厂', specification: 'GS22', requirementAmount: 35.0, unit: '吨', unitPriceExclTax: 12000, unitPriceInclTax: 13560, amountExclTax: 420000, applicantName: '张管理员', applicantDepartment: '计划部', productionType: '自产', expectedCompletionDate: '2026-01-20' },
    
    // --- 香精香料明细 (保持合并演示) ---
    { id: 'df27-1', productType: '料液 NX0160L20（合作加工）', brandGrade: 'NX0160L20', subBrandGrade: 'NX0160L20-01', productName: '料液', productCode: 'LY-NX-160-20', customerName: '赣州卷烟厂', specification: '标准', requirementAmount: 3.760, unit: '吨', unitPriceExclTax: 5000, unitPriceInclTax: 5650, amountExclTax: 18800, applicantName: '李经理', applicantDepartment: '营销中心', productionType: '委托加工', expectedCompletionDate: '2026-02-07' },
    { id: 'df27-2', productType: '料液 NX0160L20（合作加工）', brandGrade: 'NX0160L20', subBrandGrade: 'NX0160L20-02', productName: '料液', productCode: 'LY-NX-160-20', customerName: '哈尔滨卷烟厂', specification: '标准', requirementAmount: 5.352, unit: '吨', unitPriceExclTax: 5000, unitPriceInclTax: 5650, amountExclTax: 26760, applicantName: '李经理', applicantDepartment: '营销中心', productionType: '委托加工', expectedCompletionDate: '2026-02-02' },
    { id: 'df27-3', productType: '料液 NX0160L20（合作加工）', brandGrade: 'NX0160L20', subBrandGrade: 'NX0160L20-03', productName: '料液', productCode: 'LY-NX-160-20', customerName: '柳州卷烟厂', specification: '标准', requirementAmount: 1.050, unit: '吨', unitPriceExclTax: 5000, unitPriceInclTax: 5650, amountExclTax: 5250, applicantName: '李经理', applicantDepartment: '营销中心', productionType: '委托加工', expectedCompletionDate: '2026-02-07' },
    { id: 'df27-4', productType: '料液 NX0160L20（合作加工）', brandGrade: 'NX0160L20', subBrandGrade: 'NX0160L20-04', productName: '料液', productCode: 'LY-NX-160-20', customerName: '延安卷烟厂', specification: '标准', requirementAmount: 1.950, unit: '吨', unitPriceExclTax: 5000, unitPriceInclTax: 5650, amountExclTax: 9750, applicantName: '李经理', applicantDepartment: '营销中心', productionType: '委托加工', expectedCompletionDate: '2026-02-07' },

    // 重点演示：表香 NX0160X20（合作加工）的分拆需求 (合计 4.702)
    { id: 'df28-1', productType: '表香 NX0160X20（合作加工）', brandGrade: 'NX0160X20', subBrandGrade: 'NX0160X20-01', productName: '表香', productCode: 'BX-NX-160-20', customerName: '赣州卷烟厂', specification: '标准', requirementAmount: 1.430, unit: '吨', unitPriceExclTax: 8000, unitPriceInclTax: 9040, amountExclTax: 11440, applicantName: '王经理', applicantDepartment: '营销中心', productionType: '委托加工', expectedCompletionDate: '2026-02-07' },
    { id: 'df28-2', productType: '表香 NX0160X20（合作加工）', brandGrade: 'NX0160X20', subBrandGrade: 'NX0160X20-02', productName: '表香', productCode: 'BX-NX-160-20', customerName: '哈尔滨卷烟厂', specification: '标准', requirementAmount: 2.082, unit: '吨', unitPriceExclTax: 8000, unitPriceInclTax: 9040, amountExclTax: 16656, applicantName: '王经理', applicantDepartment: '营销中心', productionType: '委托加工', expectedCompletionDate: '2026-02-02' },
    { id: 'df28-3', productType: '表香 NX0160X20（合作加工）', brandGrade: 'NX0160X20', subBrandGrade: 'NX0160X20-03', productName: '表香', productCode: 'BX-NX-160-20', customerName: '柳州卷烟厂', specification: '标准', requirementAmount: 0.440, unit: '吨', unitPriceExclTax: 8000, unitPriceInclTax: 9040, amountExclTax: 3520, applicantName: '王经理', applicantDepartment: '营销中心', productionType: '委托加工', expectedCompletionDate: '2026-02-07' },
    { id: 'df28-4', productType: '表香 NX0160X20（合作加工）', brandGrade: 'NX0160X20', subBrandGrade: 'NX0160X20-04', productName: '表香', productCode: 'BX-NX-160-20', customerName: '延安卷烟厂', specification: '标准', requirementAmount: 0.750, unit: '吨', unitPriceExclTax: 8000, unitPriceInclTax: 9040, amountExclTax: 6000, applicantName: '王经理', applicantDepartment: '营销中心', productionType: '委托加工', expectedCompletionDate: '2026-02-07' },

    // 其他散项明细
    { id: 'df29-1', productType: '料液', brandGrade: 'NX0200L19', subBrandGrade: 'NX0200L19-01', productName: '料液', productCode: 'LY-NX-200-19', customerName: '南京卷烟厂', specification: '标准', requirementAmount: 5.400, unit: '吨', unitPriceExclTax: 5200, unitPriceInclTax: 5876, amountExclTax: 28080, applicantName: '赵经理', applicantDepartment: '营销中心', productionType: '自产', expectedCompletionDate: '2026-02-02' },
    { id: 'df29-2', productType: '料液', brandGrade: 'NX0200L19', subBrandGrade: 'NX0200L19-02', productName: '料液', productCode: 'LY-NX-200-19', customerName: '南京卷烟厂', specification: '标准', requirementAmount: 2.700, unit: '吨', unitPriceExclTax: 5200, unitPriceInclTax: 5876, amountExclTax: 14040, applicantName: '赵经理', applicantDepartment: '营销中心', productionType: '自产', expectedCompletionDate: '2026-02-28' },
  ]
};
