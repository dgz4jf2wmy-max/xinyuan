...
export const mockProductionPoolData: ProductionPlanPool[] = [
  ...
  createPoolRecord(2, '再造梗丝', ProductionTypeEnum.StemRecipeFinished, '再造梗丝（省内）', 'GS30', '15', 45, '江苏中烟工业有限责任公司', '淮安'),
  createPoolRecord(3, '再造梗丝', ProductionTypeEnum.StemRecipeFinished, '再造梗丝（省内）', 'GS01', '15', 30, '江苏中烟工业有限责任公司', '徐州'),
  createPoolRecord(4, '再造梗丝', ProductionTypeEnum.StemRecipeFinished, '再造梗丝（省内）', 'GS60', '15', 90, '江苏中烟工业有限责任公司', '苏州'),
  createPoolRecord(5, '再造烟叶', ProductionTypeEnum.TobaccoRecipeFinished, '再造烟叶（省外）', 'HBZY-10', '15', 200, '河北中烟工业有限责任公司', '石家庄'),
  createPoolRecord(6, '再造烟叶', ProductionTypeEnum.TobaccoRecipeFinished, '再造烟叶（省外）', 'JSN08', '15', 200, '山东中烟工业有限责任公司', '济南'),
  ...
  // ----------- 第三部分: 醇化相关 (演示用) -----------
  createPoolRecord(21, '再造烟叶', ProductionTypeEnum.TobaccoAgeing, 'ZY01A-1', 'ZY-01A', '15', 120, '江苏中烟工业有限责任公司', '南京'),
  createPoolRecord(22, '再造梗丝', ProductionTypeEnum.StemAgeing, 'GS08B-1', 'GS-08B', '15', 85, '安徽中烟工业有限责任公司', '芜湖'),
  createPoolRecord(23, '再造烟叶', ProductionTypeEnum.TobaccoAgeing, 'ZYEXP02-1', 'ZY-EXP-02', '15', 200, '中烟国际', '上海港'),
  createPoolRecord(24, '再造梗丝', ProductionTypeEnum.StemAgeing, 'GS12A-1', 'GS-12A', '15', 60, '江苏中烟工业有限责任公司', '淮海'),
